...
<body>
						...
						<p class="register-title">회원정보 입력</p>
							<div class="label-area" id="id_check">	
									...
									<span class="label-text">아이디</span>
										...
										<input type="text" name="id" id="id" class="form-control id" placeholder="아이디 입력" required>
										
										
										<input type="button" id="idbtn" value="중복 검사" class="fill-button gray idcheck">
							...
							<div class="label-area" id="pwCheck_check">	
									...
									<span class="label-text">비밀번호 확인</span>
										<div class="line id-line">
										<input type="password" name="pwCheck" class="form-control" placeholder="비밀번호 확인 입력" required>
							...
							<div class="label-area" id="ssn_check">	
									...
									<span class="label-text">주민번호</span>
										...
										<div class="line id-line">
										<input type="text" id="ssnInput" name="ssn" class="form-control" placeholder="주민번호 입력" maxlength="14" required>
										<font id="checkSsn" size = "1"></font>
										</div>
							...
							<div class="label-area" id="address_check">	
									...
									<span class="label-text">주소</span>
										...
										<div class="line id-line">
										<input type="text" id="address" name="address" class="form-control email" placeholder="주소 입력" required>
										<input type="button" onclick="daumPostcode()" class="fill-button gray idcheck" value="주소 검색"><br>
										</div>
										<p class="explanation"></p>
										<input type="text" id="addressPlus" name="addressPlus" class="form-control" placeholder="상세 주소 입력" required>
	...
	<script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=4ca8da1af1b5a90ad610b927d18ab748&libraries=services"></script>
	<script>
