...
<body
	...
	<a href="1.html"><img src="/house/asset/images/adminlogo.png" class="logo"></a>
	</div>
	<div class="top">회원관리</div>
	<div class="g-wrapper">
		<a href="manage.jsp" style="text-decoration: none; color: black">
			<div class="gen2">일반회원</div>
		</a>
		<div class="ngen2">중개사</div>
	</div>
	<div class="input-wrapper">
		...
		<input
			...
			type="text">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<button type="button" class="btn btn-primary">허위매물 다수 등록 중계사</button>
	</div>
	<table class="table">
		<tr>
			<th scope="col">번호</th>
			<th scope="col">이름</th>
			<th scope="col">아이디</th>
			<th scope="col">중개업소명</th>
			<th scope="col">중개등록번호</th>
			<th scope="col">이메일</th>
		...
		<c:forEach items="${list}" var="dto">
			...
			<tr>
		        ...
		        <div id="btn-wrapper"><button type="button"
                class="btn btn-secondary" style="float: right;">돌아가기</button></div>
