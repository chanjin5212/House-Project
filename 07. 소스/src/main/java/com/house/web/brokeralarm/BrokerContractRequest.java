...
public class BrokerContractRequest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(n ==1) {
			...
			pagebar += String.format("<li class=\"page-item\">\r\n"
					+ "					      <a class=\"page-link\" href=\"/house/web/brokeralarm/brokerContractRequest?page=%d\" aria-label=\"Previous\">\r\n"
					+ "					        <span aria-hidden=\"true\">&laquo;</span>\r\n"
					+ "					      </a>\r\n"
					+ "					    </li>", n-1);
		...
		while(!(loop > blockSize || n > totalPage)) {
			...
			if(n == nowPage) {
				pagebar += String.format(" <li class=\"page-item active\"><a class=\"page-link\" href=\"#!\">%d</a></li>", n, n);
					...
					pagebar += String.format(" <li class=\"page-item\"><a class=\"page-link\" href=\"/house/web/brokeralarm/brokerContractRequest?page=%d\">%d</a></li>", n, n);
		...
		if(n > totalPage) {
			...
			pagebar += String.format(" <li class=\"page-item\">\r\n"
					+ "					      <a class=\"page-link\" href=\"/house/web/brokeralarm/brokerContractRequest?page=%d\" aria-label=\"Next\">\r\n"
					+ "					        <span aria-hidden=\"true\">&raquo;</span>\r\n"
					+ "					      </a>\r\n"
					+ "					    </li>\r\n"
					+ "					 ", n);
		...
		ArrayList<BrokerDealListViewDTO> list = dao.getContractList(map);
		
		
		
		String couselCount = dao.getCounselCount(id);
		
		
		String countNew = dao.countNewContract(id);
